...
export class ContextManager {
  ...
  private buildCompressPrompt(stepDescriptions: string): string {
    return [
      ...
      '1. List all URLs navigated to and the current page URL',
      '2. Preserve any IDs, usernames, tokens, form values, or extracted data',
      '3. State what actions were taken (click, type, scroll, etc.) and their results',
      '4. Describe the current state: what page are we on, what has been accomplished, what remains',
      '5. Keep the summary under 800 tokens but do NOT omit critical data',
      '',
